...
before packages are loaded."
  ...
  ;; create notifications for org entries -- does not work :(
  (require 'appt)
  (setq
...
;; saves to gmail into sent folder
;; (defun save-sent-mail ()
;;   (start-process-shell-command "mbsync" nil "mbsync -a"))
